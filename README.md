...
- `packages/subagent-coder` — Registers the `coder` subagent profile: a bounded software engineering subagent with a fixed prompt, tool set, authority scope and budget.
