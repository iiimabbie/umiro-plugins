...
export interface PluginInstance {
  readonly contributions: {
    ...
    readonly jobs?: readonly { readonly id: string; readonly schedule: string; readonly run: (context: { readonly jobId: string; readonly signal?: AbortSignal }) => Promise<void> }[];
